...
void loop() {
  ...
  if (start == 15 && left == 0)
  {
    can.positionwheel(3000, -190000, 0, 1);//继续后退 到门口
...
void zuo()
{
  can.positionwheel(2000, -200000, 0, 1);
  can.positionwheel(2000, 200000, 0, 2);
  can.positionwheel(2000, -200000, 0, 3);
  can.positionwheel(2000, 200000, 0, 4);
  delay(4000);
}
void zuoj()
{
